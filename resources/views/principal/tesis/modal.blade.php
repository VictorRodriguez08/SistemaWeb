		...
		<div class="modal-content">
			...
			<div class="modal-body">
					...
					<div id="divOpciones">
						...
						<div class="col-xs-12 col-md-6" id="divCargo">
							<select id="select_cargo" name="cargo_jurado" class="form-control" required>
								<option value="">--Seleccione un Cargo--</option>
								<option value="0">Presidente</option>
								<option value="1">Primer Vocal</option>
								<option value="2">Segundo Vocal</option>
							</select>
						</div>
